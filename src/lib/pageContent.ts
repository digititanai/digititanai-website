...
export interface AboutCredential { icon: string; label: string; sub: string }
export interface AboutApproachStep { num: string; title: string; desc: string }
export interface AboutWhyUsItem { icon: string; title: string; desc: string }
...
export interface AboutPageContent {
  ...
  approach: AboutApproachStep[]
  // Section 5: Why Choose Us
  whyUsBadge: string
  whyUsHeading: string
  whyUsSubtitle: string
  whyUs: AboutWhyUsItem[]
  // Section 6: Skills
  skillsBadge: string
...
export const defaultAboutContent: AboutPageContent = {
  // Section 1: Hero
  badge: 'About DigiTitan AI',
  heroHeading: 'We help brands grow with data, AI, and relentless execution',
  heroSubtitle: 'DigiTitan AI is a performance marketing agency that combines deep technical expertise with creative strategy to drive measurable growth for ambitious brands.',
  // Section 2: Stats
  stats: [
  ...
  whoWeAreHeading: 'A team of marketers, engineers, and data nerds who actually care about your numbers',
  checklist: [
  ...
  credentials: [
    { icon: 'Award', label: 'Google Partner', sub: 'Certified Agency' },
    { icon: 'BarChart3', label: '5+ Years', sub: 'In Digital Marketing' },
    { icon: 'Cpu', label: 'AI-Powered', sub: 'Automation & Insights' },
    { icon: 'Heart', label: '98% Retention', sub: 'Client Satisfaction Rate' },
  ],
  approachBadge: 'Our Approach',
  approachHeading: 'How We Deliver Results',
  approach: [
    { num: '01', title: 'Discover', desc: 'Deep dive into your business, audience, competitors, and goals to uncover real opportunities.' },
    { num: '02', title: 'Strategize', desc: 'Build a custom roadmap backed by data — channels, budgets, timelines, and KPIs all defined.' },
    { num: '03', title: 'Execute', desc: 'Launch campaigns, build systems, and deploy tracking — fast, precise, and fully managed.' },
    { num: '04', title: 'Optimize', desc: 'Continuous testing, reporting, and refinement. We never set and forget — we scale what works.' },
  ],
  whyUsBadge: 'Why DigiTitan AI',
  whyUsHeading: 'What Sets Us Apart',
  whyUsSubtitle: '',
  whyUs: [
    { icon: 'Zap', title: 'AI-First Approach', desc: 'We leverage AI across every workflow — from content creation to bid management to reporting.' },
    { icon: 'Shield', title: 'Full Transparency', desc: 'Real-time dashboards, weekly reports, and direct Slack access. No black boxes, ever.' },
    { icon: 'Target', title: 'ROI Obsessed', desc: 'Every dollar spent is tracked. We optimize for revenue and profit, not impressions.' },
    { icon: 'Rocket', title: 'Fast Execution', desc: 'Strategy to launch in days. Our agile process eliminates bottlenecks and bureaucracy.' },
    { icon: 'Users', title: 'Dedicated Team', desc: 'A senior strategist, not a junior account manager. Direct access to the people doing the work.' },
    { icon: 'Globe', title: 'Full-Stack', desc: 'Tracking, ads, SEO, automation, dev, CRM — one agency, one strategy, zero silos.' },
  ],
  // Section 6: Skills
...
export const defaultPageContent: Record<string, Record<string, string>> = {
  about: {
    ...
    heroHeading: defaultAboutContent.heroHeading,
  ...
  contact: {
    ...
    socials: JSON.stringify([
      { label: 'LinkedIn', url: 'https://linkedin.com/in/digititanai', icon: 'Linkedin' },
      { label: 'Twitter', url: 'https://x.com/digititanai', icon: 'Twitter' },
      { label: 'Facebook', url: 'https://facebook.com/digititanai', icon: 'Facebook' },
      { label: 'Instagram', url: 'https://instagram.com/digititanai', icon: 'Instagram' },
      { label: 'YouTube', url: 'https://youtube.com/@digititanai', icon: 'Youtube' },
      { label: 'GitHub', url: 'https://github.com/digititanai', icon: 'Github' },
    ]),
    seoTitle: '',
    seoDescription: '',
    seoImage: '',
  ...
  footer: {
    ...
    ctaBtn2Link: '/contact',
    brandDescription: 'AI-powered digital solutions agency helping brands grow through data-driven strategies and intelligent automation.',
    email: 'digititanai@gmail.com',
    phone: '+880 1XXX-XXXXXX',
    location: 'Dhaka, Bangladesh',
    hours: 'Mon \u2013 Fri, 6PM \u2013 12AM',
    copyright: 'DigiTitan AI. All rights reserved.',
    navLinks: JSON.stringify([
      { label: 'Home', href: '/' },
      { label: 'About', href: '/about' },
      { label: 'Services', href: '/services' },
